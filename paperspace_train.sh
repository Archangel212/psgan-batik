...
experiment_name=WGAN_MLP_kernel=5,generator_upsampleConv2d,generator_leakyRelu=0.2,instance_noise_mean=0.1,zl_dim=40,zg_dim=20,zp_dim=3,ngf=64,ndf=64,learning_rate_g=2e-4,learning_rate_d=2e-4,batch_size=25,weight_decay=0
