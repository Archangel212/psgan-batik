...
#experiment 1
model_hyperparameters_1=kernel=5,zl_dim=20,zg_dim=40,zp_dim=6,ngf=64,ndf=64,batch_size=25
...
model_state_2=MLP,samefakeimg,G_upsampleConv2d,instance_noise_mean=0.1,shuffle_ds=False,real_label_smoothing=1


training 64_Kawung $model_hyperparameters_2 $model_state_2 0
training 64_Parang $model_hyperparameters_2 $model_state_2 0
training 64_Nitik $model_hyperparameters_2 $model_state_2 0
training 64_Lereng $model_hyperparameters_2 $model_state_2 0
training 64_Ceplok $model_hyperparameters_2 $model_state_2 0

training 128_Kawung $model_hyperparameters_2 $model_state_2 0
training 128_Parang $model_hyperparameters_2 $model_state_2 0
training 128_Nitik $model_hyperparameters_2 $model_state_2 0
training 128_Lereng $model_hyperparameters_2 $model_state_2 0
training 128_Ceplok $model_hyperparameters_2 $model_state_2 0
