...
model_hyperparameters=kernel=5,G_upsampleConv2d,instance_noise_mean=0.1,zl_dim=40,zg_dim=20,zp_dim=3,ngf=128,ndf=128,batch_size=16,BN_D=False
model_state=MLP_samefakeimg,niter=500
