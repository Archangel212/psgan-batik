...
experiment_name=MLP_samefakeimg_d_iter_reallabel=2_optimD_step_reallabel_fakelabel,kernel=5,generator_upsampleConv2d,instance_noise_mean=0.1,zl_dim=40,zg_dim=20,zp_dim=3,ngf=128,ndf=128,learning_rate_g=2e-4,learning_rate_d=2e-4,batch_size=16,weight_decay=0
