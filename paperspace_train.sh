...
model_hyperparameters=kernel=5,zl_dim=40,zg_dim=20,zp_dim=0,ngf=128,ndf=128,batch_size=16
model_state=MLP,samefakeimg,G_upsampleConv2d,instance_noise_mean=0.1,shuffle_ds=False,niter=100
