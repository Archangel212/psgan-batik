training()
{
    ...
    python PSGAN.py --texture_path batik_dataset/$batik_dataset_name --output_folder ./log/$batik_dataset_name/$experiment_name --nBlocksG $4 --niter 1000 >> ./log/$batik_dataset_name/$model_hyperparameters/$model_state.txt
...
#experiment 1
model_hyperparameters_1=kernel=5,zl_dim=20,zg_dim=40,zp_dim=4,ngf=64,ndf=64,batch_size=25,niter=1000
