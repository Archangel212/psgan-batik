...
parser.add_argument('--nDepG', type=int, default=6,help='depth of Unet Generator')
parser.add_argument('--nDepD', type=int, default=6,help='depth of Discriminator')
...
parser.add_argument('--real_label_smoothing', type=float, default=0.0,help='smooth positive labels percentage, default 0')
