...
parser.add_argument('--nBlocks', type=int, default=1,help='additional res blocks for complexity in the unet')
...
parser.add_argument('--real_label_smoothing', type=float, default=0.886,help='smooth positive labels percentage, default 0')
